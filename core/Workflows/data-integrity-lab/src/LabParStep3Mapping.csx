...
/// <summary>
/// Parallel branch 3: runs concurrently with the other three branches (same order),
...
/// </summary>
public class LabParStep3Mapping : ScriptBase, IMapping
{
    ...
    public Task<ScriptResponse> OutputHandler(ScriptContext context)
    {
        ...
        target["par3"] = true;
        target["par3At"] = DateTime.UtcNow.ToString("o");
        LogInformation("LabParStep3Mapping: par3 stamped");
