...
/// <summary>
/// Parallel branch 4: runs concurrently with the other three branches (same order),
...
/// </summary>
public class LabParStep4Mapping : ScriptBase, IMapping
{
    ...
    public Task<ScriptResponse> OutputHandler(ScriptContext context)
    {
        ...
        target["par4"] = true;
        target["par4At"] = DateTime.UtcNow.ToString("o");
        LogInformation("LabParStep4Mapping: par4 stamped");
