...
/// <summary>
/// record-note ($self shared transition) sayaci.
/// <para>
...
/// </para>
/// </summary>
public class RecordNoteMapping : ScriptBase, IMapping
{
    ...
    public Task<ScriptResponse> OutputHandler(ScriptContext context)
    {
        ...
        var current = 0;
        if (inst != null && inst.TryGetValue("noteMarks", out var raw) && raw != null)
        {
        ...
        target["noteMarks"] = current + 1;

        LogInformation($"RecordNoteMapping: noteMarks {current} -> {current + 1}");
