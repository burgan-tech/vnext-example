...
/// <summary>
/// review state'inin onEntry sayaci.
/// <para>
...
/// </para>
/// </summary>
public class ReviewEntryMapping : ScriptBase, IMapping
{
    ...
    public Task<ScriptResponse> OutputHandler(ScriptContext context)
    {
        ...
        var current = 0;
        if (inst != null && inst.TryGetValue("reviewEntries", out var raw) && raw != null)
        {
        ...
        target["reviewEntries"] = current + 1;

        LogInformation($"ReviewEntryMapping: reviewEntries {current} -> {current + 1}");
