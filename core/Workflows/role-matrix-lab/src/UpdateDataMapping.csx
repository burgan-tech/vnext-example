...
/// <summary>
/// updateData well-known transition sayaci.
/// <para>
...
/// </para>
/// </summary>
public class UpdateDataMapping : ScriptBase, IMapping
{
    ...
    public Task<ScriptResponse> OutputHandler(ScriptContext context)
    {
        ...
        var current = 0;
        if (inst != null && inst.TryGetValue("updateDataMarks", out var raw) && raw != null)
        {
        ...
        target["updateDataMarks"] = current + 1;

        LogInformation($"UpdateDataMapping: updateDataMarks {current} -> {current + 1}");
