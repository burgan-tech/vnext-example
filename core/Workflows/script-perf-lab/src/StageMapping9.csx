...
/// <summary>
/// Stage 9: instance data'ya chunkKb boyutunda deterministik chunk merge eder (delta-only).
/// chunkKb start body'den okunur; helper'lar (A7) chunk + stamp uretir.
/// </summary>
public class StageMapping9 : ScriptBase, IMapping
{
    ...
    public Task<ScriptResponse> OutputHandler(ScriptContext context)
    {
        ...
        stage["stamp"] = PerfStampHelper.Stage(9, context.Instance.Id.ToString());
        stage["chunk"] = PerfChunkHelper.Build(9, chunkKb);
        target["stage9"] = stage;
