...
/// <summary>
/// Stage 6: instance data'ya chunkKb boyutunda deterministik chunk merge eder (delta-only).
...
/// </summary>
public class StageMapping6 : ScriptBase, IMapping
{
    ...
    public Task<ScriptResponse> OutputHandler(ScriptContext context)
    {
        ...
        stage["stamp"] = PerfStampHelper.Stage(6, context.Instance.Id.ToString());
        stage["chunk"] = PerfChunkHelper.Build(6, chunkKb);
        target["stage6"] = stage;
