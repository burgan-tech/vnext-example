...
/// <summary>
/// Stage 5: instance data'ya chunkKb boyutunda deterministik chunk merge eder (delta-only).
...
/// </summary>
public class StageMapping5 : ScriptBase, IMapping
{
    ...
    public Task<ScriptResponse> OutputHandler(ScriptContext context)
    {
        ...
        stage["stamp"] = PerfStampHelper.Stage(5, context.Instance.Id.ToString());
        stage["chunk"] = PerfChunkHelper.Build(5, chunkKb);
        target["stage5"] = stage;
