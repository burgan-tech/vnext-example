...
/// <summary>
/// Stage 7: instance data'ya chunkKb boyutunda deterministik chunk merge eder (delta-only).
/// chunkKb start body'den okunur; helper'lar (A7) chunk + stamp uretir.
/// </summary>
public class StageMapping7 : ScriptBase, IMapping
{
    ...
    public Task<ScriptResponse> OutputHandler(ScriptContext context)
    {
        ...
        stage["stamp"] = PerfStampHelper.Stage(7, context.Instance.Id.ToString());
        stage["chunk"] = PerfChunkHelper.Build(7, chunkKb);
        target["stage7"] = stage;
