...
/// <summary>
/// Stage 3: instance data'ya chunkKb boyutunda deterministik chunk merge eder (delta-only).
...
/// </summary>
public class StageMapping3 : ScriptBase, IMapping
{
    ...
    public Task<ScriptResponse> OutputHandler(ScriptContext context)
    {
        ...
        stage["stamp"] = PerfStampHelper.Stage(3, context.Instance.Id.ToString());
        stage["chunk"] = PerfChunkHelper.Build(3, chunkKb);
        target["stage3"] = stage;
