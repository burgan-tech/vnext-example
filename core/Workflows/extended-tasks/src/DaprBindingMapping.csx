...
public class DaprBindingMapping : ScriptBase, IMapping
{
    ...
    public Task<ScriptResponse> OutputHandler(ScriptContext context)
    {
        ...
        result.taskResults.daprBinding = new ExpandoObject();
        result.taskResults.daprBinding.completed = true;
        result.taskResults.daprBinding.executedAt = DateTime.UtcNow.ToString("o");

        LogInformation("DaprBindingMapping completed");
