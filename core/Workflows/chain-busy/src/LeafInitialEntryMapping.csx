...
/// </para>
/// </summary>
public class LeafInitialEntryMapping : ScriptBase, IMapping
{
    ...
    public Task<ScriptResponse> OutputHandler(ScriptContext context)
    {
        ...
        var current = 0;
        if (inst != null && inst.TryGetValue("leafInitialEntries", out var raw) && raw != null)
        {
        ...
        target["leafInitialEntries"] = current + 1;

        LogInformation($"LeafInitialEntryMapping: leafInitialEntries {current} -> {current + 1}");
