...
/// </para>
/// </summary>
public class LeafFinishMapping : ScriptBase, IMapping
{
    ...
    public Task<ScriptResponse> OutputHandler(ScriptContext context)
    {
        ...
        var current = 0;
        if (inst != null && inst.TryGetValue("leafFinishMarks", out var raw) && raw != null)
        {
        ...
        target["leafFinishMarks"] = current + 1;

        LogInformation($"LeafFinishMapping: leafFinishMarks {current} -> {current + 1}");
