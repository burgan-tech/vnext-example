...
/// <summary>
/// B'nin kendi shared transition'i.
/// <para>
...
/// </para>
/// </summary>
public class MiddleSharedMarkMapping : ScriptBase, IMapping
{
    ...
    public Task<ScriptResponse> OutputHandler(ScriptContext context)
    {
        ...
        var current = 0;
        if (inst != null && inst.TryGetValue("middleSharedMarks", out var raw) && raw != null)
        {
        ...
        target["middleSharedMarks"] = current + 1;

        LogInformation($"MiddleSharedMarkMapping: middleSharedMarks {current} -> {current + 1}");
