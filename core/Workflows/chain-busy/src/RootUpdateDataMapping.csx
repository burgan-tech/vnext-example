...
/// <summary>
/// A'nin updateData sayaci (aktif subflow'da data-only calisir).
/// <para>
...
/// </para>
/// </summary>
public class RootUpdateDataMapping : ScriptBase, IMapping
{
    ...
    public Task<ScriptResponse> OutputHandler(ScriptContext context)
    {
        ...
        var current = 0;
        if (inst != null && inst.TryGetValue("rootUpdates", out var raw) && raw != null)
        {
        ...
        target["rootUpdates"] = current + 1;

        LogInformation($"RootUpdateDataMapping: rootUpdates {current} -> {current + 1}");
