...
/// </para>
/// </summary>
public class MiddleEntryMapping : ScriptBase, IMapping
{
    ...
    public Task<ScriptResponse> OutputHandler(ScriptContext context)
    {
        ...
        var current = 0;
        if (inst != null && inst.TryGetValue("middleEntries", out var raw) && raw != null)
        {
        ...
        target["middleEntries"] = current + 1;

        LogInformation($"MiddleEntryMapping: middleEntries {current} -> {current + 1}");
