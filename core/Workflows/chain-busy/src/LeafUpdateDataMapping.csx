...
/// <summary>
/// C'nin updateData sayaci — yasam dongusu atlanarak calisir.
/// <para>
...
/// </para>
/// </summary>
public class LeafUpdateDataMapping : ScriptBase, IMapping
{
    ...
    public Task<ScriptResponse> OutputHandler(ScriptContext context)
    {
        ...
        var current = 0;
        if (inst != null && inst.TryGetValue("leafUpdates", out var raw) && raw != null)
        {
        ...
        target["leafUpdates"] = current + 1;

        LogInformation($"LeafUpdateDataMapping: leafUpdates {current} -> {current + 1}");
