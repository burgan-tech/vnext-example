...
/// <summary>
/// A -> B subflow giris/cikis mapping'i.
/// </summary>
public class RootToMiddleSubFlowMapping : ScriptBase, ISubFlowMapping
{
    public Task<ScriptResponse> InputHandler(ScriptContext context)
    {
        ...
        LogInformation("RootToMiddleSubFlowMapping: prepared sub input");
    ...
    public Task<ScriptResponse> OutputHandler(ScriptContext context)
    {
        ...
        target["middleCompleted"] = true;
        LogInformation("RootToMiddleSubFlowMapping: merged sub output");
