...
/// <summary>
/// YALNIZ C'de tanimli shared transition — A'dan tetiklenip C'ye forward edilmeli.
/// <para>
...
/// </para>
/// </summary>
public class LeafOnlySharedMapping : ScriptBase, IMapping
{
    ...
    public Task<ScriptResponse> OutputHandler(ScriptContext context)
    {
        ...
        var current = 0;
        if (inst != null && inst.TryGetValue("leafOnlyMarks", out var raw) && raw != null)
        {
        ...
        target["leafOnlyMarks"] = current + 1;

        LogInformation($"LeafOnlySharedMapping: leafOnlyMarks {current} -> {current + 1}");
