...
/// <summary>
/// root-waiting onExit sayaci — updateData artirmamali, $self shared transition ARTIRMALI.
/// <para>
...
/// </para>
/// </summary>
public class RootExitMapping : ScriptBase, IMapping
{
    ...
    public Task<ScriptResponse> OutputHandler(ScriptContext context)
    {
        ...
        var current = 0;
        if (inst != null && inst.TryGetValue("rootExits", out var raw) && raw != null)
        {
        ...
        target["rootExits"] = current + 1;

        LogInformation($"RootExitMapping: rootExits {current} -> {current + 1}");
