...
| Property | Value |
| --- | --- |
| Key | `demand-deposit-input-view` |
| Domain | `core` |
| Version | 1.0.0 |
| Content Type | JSON |
| Display Mode | full-page |
| Tags | `banking`, `account-details`, `demand-deposit`, `ui-view` |
...
```json
{
  ...
  "dataSchema": "urn:vnext:res:schema:core:demand-deposit-input",
  "lookups": [
    "branchDetail"
  ],
  "view": {
    ...
    "children": [
      {
        ...
        "children": [
          ...
          },
          {
            "type": "Text",
            "content": {
              "en": "Demand Deposit Details",
              "tr": "Vadesiz Mevduat Bilgileri"
            },
          ...
          },
          {
            "type": "Text",
            "content": {
              "en": "Fill in the details for your everyday banking account.",
              "tr": "Günlük bankacılık hesabınız için bilgileri doldurun."
            },
            "variant": "bodyMedium"
          },
          {
          ...
          },
          {
            ...
            "children": [
              ...
              },
              {
                ...
                "icon": "arrow_forward",
                "action": "dispatch",
                "command": "urn:vnext:flow:transition:core:account-opening:submit-demand-deposit-info",
                "validate": true
              }
            ]
          }
