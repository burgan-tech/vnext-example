...
| Property | Value |
| --- | --- |
| Key | `savings-account-input-view` |
| Domain | `core` |
| Version | 1.0.0 |
| Content Type | JSON |
| Display Mode | full-page |
| Tags | `banking`, `account-details`, `savings-account`, `ui-view` |
...
```json
{
  ...
  "dataSchema": "urn:vnext:res:schema:core:savings-account-input",
  "lookups": [
    "branchDetail"
  ],
  "view": {
    ...
    "children": [
      {
        ...
        "children": [
          ...
          },
          {
            "type": "Text",
            "content": {
              "en": "Set your savings goal and we will help you track progress over time.",
              "tr": "Birikim hedefinizi belirleyin, zaman içinde ilerlemenizi takip etmenize yardımcı olalım."
            },
            "variant": "bodyMedium"
          },
          {
          ...
          },
          {
            ...
            "children": [
              ...
              },
              {
                ...
                "icon": "arrow_forward",
                "action": "submit",
                "command": "urn:vnext:flow:transition:core:account-opening:submit-savings-account-info"
              }
            ]
          }
        ]
